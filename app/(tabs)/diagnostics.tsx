...
export default function DiagnosticsScreen() {
  ...
  const styles = getDiagnosticsStyles(colors);
...
const getDiagnosticsStyles = (c: AppColors) =>
  StyleSheet.create({
    ...
    menuCardDesc: { fontSize: 13, color: c.textMuted },
    chevron: { fontSize: 26, color: c.textFaint, marginLeft: 10 },
    ...
    disabledIcon: { backgroundColor: c.border },
    ...
    backButtonText: { color: c.accent, fontSize: 14, fontWeight: "700" },
    warningCard: {
    ...
    cylButtonLabel: { fontSize: 11, fontWeight: "700", color: c.textMuted },
    o2DisplayCard: {
      backgroundColor: c.card,
      borderWidth: 1,
      borderColor: c.border,
    ...
    infoText: { color: c.textMuted, fontSize: 13, lineHeight: 20 },
  });
